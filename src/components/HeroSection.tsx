...
import { Mail, Github, MapPin, Linkedin, HardDriveDownload } from "lucide-react";
  ...
  return (
    <section className="py-16 md:py-24 relative overflow-hidden">
      <div className="container max-w-4xl mx-auto px-6 md:px-4 relative z-10">
          ...
          >
            <div className="relative">
              ...
              <img
                ...
                alt="Profile"
                className="w-48 md:w-60 rounded-full relative ring-2 ring-blue-800/50"
        ...
        <MotionWrapper>
          <div className="bg-gradient-to-r from-blue-500/10 to-blue-300/10 backdrop-blur-sm backdrop-filter p-4 rounded-lg border border-blue-500/20 shadow-sm">
